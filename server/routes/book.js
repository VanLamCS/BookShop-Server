...
bookRoute.delete("/delete", verifyToken, checkPermission, bookController.deleteBook);
bookRoute.patch("/update", verifyToken, checkPermission, bookController.updateBook);
bookRoute.patch('/update-star', verifyToken, checkPermission, bookController.updateStar);
